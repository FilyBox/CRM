...
export const templates: Record<string, TemplateDefinition> = {
  ...
  'document-rejected': {
    ...
    fields: {
      recipientName: recipientNameField,
      documentName: documentNameField,
      documentUrl: { type: 'text', label: 'Document URL', default: 'http://localhost:3000' },
      rejectionReason: {
        type: 'textarea',
  ...
  'organisation-invite': {
    ...
    fields: {
      ...
      organisationName: { type: 'text', label: 'Organisation name', default: 'Plane Contracts' },
    },
  },
  'organisation-join': {
  ...
  'confirm-team-email': {
    ...
    fields: {
      teamName: { type: 'text', label: 'Team name', default: 'Plane Contracts' },
    },
  },
  'team-delete': {
    name: 'Team delete',
  ...
  'forgot-password': {
    ...
    fields: {
      resetPasswordLink: {
        type: 'text',
        label: 'Reset link',
        default: 'http://localhost:3000/reset',
      },
    },
  },
  'reset-password': {
